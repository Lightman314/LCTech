...
public class EnergyTradeData extends TradeData {
	...
	public boolean hasStock(IEnergyTrader trader, PlayerEntity player) { return this.getStock(trader, player) > 0; }
	...
	public int getStock(IEnergyTrader trader, PlayerEntity player) { return this.getStock(trader, PlayerReference.of(player)); }
	...
	public static CompoundNBT WriteNBTList(List<EnergyTradeData> tradeList, CompoundNBT compound)
	{
		return WriteNBTList(tradeList, compound, ItemTradeData.DEFAULT_KEY);
	}
	
	public static CompoundNBT WriteNBTList(List<EnergyTradeData> tradeList, CompoundNBT compound, String tag)
	{
	...
	public static List<EnergyTradeData> LoadNBTList(int tradeCount, CompoundNBT compound)
	{
		return LoadNBTList(tradeCount, compound, ItemTradeData.DEFAULT_KEY);
	}
	
	public static List<EnergyTradeData> LoadNBTList(int tradeCount, CompoundNBT compound, String tag)
	{
