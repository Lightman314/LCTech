...
public class TechBlockTagProvider extends BlockTagsProvider {
    public TechBlockTagProvider(DataGenerator generator, @Nullable ExistingFileHelper existingFileHelper) {
        super(generator, LCTech.MODID, existingFileHelper);
    }
    @Override
    ...
    private record CustomTagAppender(TagAppender<Block> appender) {
        private CustomTagAppender(TagAppender<Block> appender) {
        ...
        public TagAppender<Block> appender() {
