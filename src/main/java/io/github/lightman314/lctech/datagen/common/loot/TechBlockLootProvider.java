...
public class TechBlockLootProvider extends BlockDropLoot {
    ...
    public TechBlockLootProvider(HolderLookup.Provider lookup) { super(lookup); }
    @Override
    ...
    {
        this.register(this.getBlockTable(block),LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(block))));
    }
