...
public class TechItemTagProvider extends ItemTagsProvider {
    ...
    public TechItemTagProvider(DataGenerator generator, BlockTagsProvider blockTagProvider, @Nullable ExistingFileHelper existingFileHelper) {
        super(generator, blockTagProvider, LCTech.MODID, existingFileHelper);
    }
    ...
    private record CustomTagAppender(TagAppender<Item> appender) {
