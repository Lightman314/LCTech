...
public class TechRecipeProvider extends EasyRecipeProvider {
    ...
    public TechRecipeProvider(DataGenerator generator) { super(generator); }
    ...
    protected void buildCraftingRecipes(@Nonnull Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(ModItems.BATTERY_LARGE.get())
                .unlockedBy("redstone", LazyTrigger(Tags.Items.DUSTS_REDSTONE))
                .unlockedBy("batteries", LazyTrigger(TechTags.Items.BATTERIES))
                .unlockedBy("energy_trader", LazyTrigger(TechTags.Items.TRADER_ENERGY))
                .pattern(" i ")
        ...
        //Fluid traders
        ShapedRecipeBuilder.shaped(ModBlocks.FLUID_TAP.get())
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.FLUID_TAP_BUNDLE.get())
                .unlockedBy("bucket", LazyTrigger(Items.BUCKET))
                .unlockedBy("trader", TraderKnowledge())
                .unlockedBy("tank", LazyTrigger(TechTags.Items.FLUID_TANK))
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.FLUID_NETWORK_TRADER_1.get())
                .unlockedBy("trader", TraderKnowledge())
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.FLUID_NETWORK_TRADER_2.get())
                .unlockedBy("trader", TraderKnowledge())
                .unlockedBy("terminal", TerminalKnowledge())
                .unlockedBy("tank", LazyTrigger(TechTags.Items.FLUID_TANK))
                .group("fluid_network_trader")
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.FLUID_NETWORK_TRADER_3.get())
                .unlockedBy("trader", TraderKnowledge())
                .unlockedBy("terminal", TerminalKnowledge())
                .unlockedBy("tank", LazyTrigger(TechTags.Items.FLUID_TANK))
                .group("fluid_network_trader")
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.FLUID_NETWORK_TRADER_4.get())
                .unlockedBy("trader", TraderKnowledge())
                .unlockedBy("terminal", TerminalKnowledge())
                .unlockedBy("tank", LazyTrigger(TechTags.Items.FLUID_TANK))
                .group("fluid_network_trader")
        ...
        //Energy Traders
        ShapedRecipeBuilder.shaped(ModBlocks.BATTERY_SHOP.get())
                .unlockedBy("trader", TraderKnowledge())
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.ENERGY_NETWORK_TRADER.get())
                .unlockedBy("trader", TraderKnowledge())
                .unlockedBy("terminal", TerminalKnowledge())
                .unlockedBy("battery", LazyTrigger(TechTags.Items.BATTERIES))
                .pattern("ibi")
        ...
        //Trader Interfaces
        ShapedRecipeBuilder.shaped(ModBlocks.FLUID_TRADER_INTERFACE.get())
                .unlockedBy("trader", TraderKnowledge())
                .unlockedBy("terminal", TerminalKnowledge())
                .pattern("ici")
                .pattern("iti")
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.ENERGY_TRADER_INTERFACE.get())
                .unlockedBy("trader", TraderKnowledge())
                .unlockedBy("terminal", TerminalKnowledge())
                .pattern("ici")
                .pattern("iti")
        ...
        //0.2.1.3
        ShapedRecipeBuilder.shaped(ModBlocks.VOID_TANK.get())
                .pattern("mgm")
                .pattern("geg")
                .pattern("mgm")
