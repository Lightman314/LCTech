...
public class TechRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(@Nonnull RecipeOutput output) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.BATTERY.get())
                ...
                .save(output.withConditions(TechCraftingConditions.BATTERIES), ID("batteries/battery"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.BATTERY_LARGE.get())
                ...
                .save(output.withConditions(TechCraftingConditions.BATTERIES),ID("batteries/large_battery"));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .save(output.withConditions(TechCraftingConditions.FLUID_TANK),ItemID("fluid_tanks/", ModBlocks.NETHERITE_TANK));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.FLUID_TAP.get())
                ...
                .save(output.withConditions(TechCraftingConditions.FLUID_TRADER),ID("traders/fluid/fluid_tap"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.FLUID_TAP_BUNDLE.get())
                ...
                .define('t', ModBlocks.IRON_TANK.get())
                .define('i', Tags.Items.INGOTS_IRON)
                .save(output.withConditions(TechCraftingConditions.FLUID_TRADER),ID("traders/fluid/fluid_tap_bundle"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.FLUID_NETWORK_TRADER_1.get())
                ...
                .define('i', Tags.Items.INGOTS_IRON)
                .define('t', ModBlocks.IRON_TANK.get())
                .save(output.withConditions(TechCraftingConditions.FLUID_TRADER,LCCraftingConditions.NETWORK_TRADER),ID("traders/network/fluid_network_trader_1"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.FLUID_NETWORK_TRADER_2.get())
                ...
                .save(output.withConditions(TechCraftingConditions.FLUID_TRADER,LCCraftingConditions.NETWORK_TRADER),ID("traders/network/fluid_network_trader_2"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.FLUID_NETWORK_TRADER_3.get())
                ...
                .save(output.withConditions(TechCraftingConditions.FLUID_TRADER,LCCraftingConditions.NETWORK_TRADER),ID("traders/network/fluid_network_trader_3"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.FLUID_NETWORK_TRADER_4.get())
                ...
                .save(output.withConditions(TechCraftingConditions.FLUID_TRADER,LCCraftingConditions.NETWORK_TRADER),ID("traders/network/fluid_network_trader_4"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.BATTERY_SHOP.get())
                ...
                .define('i', Tags.Items.INGOTS_IRON)
                .save(output.withConditions(TechCraftingConditions.ENERGY_TRADER),ID("traders/energy/battery_shop"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.ENERGY_NETWORK_TRADER.get())
                ...
                .define('i', Tags.Items.INGOTS_IRON)
                .define('b', ModItems.BATTERY.get())
                .save(output.withConditions(TechCraftingConditions.ENERGY_TRADER, LCCraftingConditions.NETWORK_TRADER),ID("traders/network/energy_network_trader"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.FLUID_TRADER_INTERFACE.get())
                ...
                .save(output.withConditions(TechCraftingConditions.FLUID_TRADER, LCCraftingConditions.TRADER_INTERFACE),ItemID(ModBlocks.FLUID_TRADER_INTERFACE));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.ENERGY_TRADER_INTERFACE.get())
                ...
                .save(output.withConditions(TechCraftingConditions.ENERGY_TRADER, LCCraftingConditions.TRADER_INTERFACE),ItemID(ModBlocks.ENERGY_TRADER_INTERFACE));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .unlocks("bucket", LazyTrigger(Items.BUCKET))
                .save(output.withConditions(TechCraftingConditions.FLUID_TRADER),ItemID("upgrades/",ModItems.FLUID_CAPACITY_UPGRADE_1));
        SmithingTransformRecipeBuilder.smithing(
                SmithingTemplate(),
                ...
                .save(output.withConditions(TechCraftingConditions.FLUID_TRADER),ItemID("upgrades/",ModItems.FLUID_CAPACITY_UPGRADE_2));
        SmithingTransformRecipeBuilder.smithing(
                SmithingTemplate(),
                ...
                .save(output.withConditions(TechCraftingConditions.FLUID_TRADER),ItemID("upgrades/",ModItems.FLUID_CAPACITY_UPGRADE_3));
        SmithingTransformRecipeBuilder.smithing(
                        SmithingTemplate(),
                ...
                .save(output.withConditions(TechCraftingConditions.FLUID_TRADER),ItemID("upgrades/",ModItems.FLUID_CAPACITY_UPGRADE_4));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .save(output.withConditions(TechCraftingConditions.ENERGY_TRADER),ItemID("upgrades/",ModItems.ENERGY_CAPACITY_UPGRADE_1));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .save(output.withConditions(TechCraftingConditions.ENERGY_TRADER),ItemID("upgrades/",ModItems.ENERGY_CAPACITY_UPGRADE_2));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .save(output.withConditions(TechCraftingConditions.ENERGY_TRADER),ItemID("upgrades/",ModItems.ENERGY_CAPACITY_UPGRADE_3));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .save(output.withConditions(TechCraftingConditions.ENERGY_TRADER),ItemID("upgrades/",ModItems.ENERGY_CAPACITY_UPGRADE_4));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.VOID_TANK.get())
                ...
                .save(output.withConditions(TechCraftingConditions.VOID_TANK),ID("fluid_tanks/void_tank"));
    ...
    private static void GenerateTankRecipe(@Nonnull RecipeOutput output, @Nonnull TagKey<Item> ingredient, @Nonnull Supplier<? extends ItemLike> result)
    {
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, result.get())
                ...
                .define('m', ingredient)
                .define('g', Tags.Items.GLASS_BLOCKS_COLORLESS)
                .save(output.withConditions(ConfigCraftingCondition.of(TechConfig.COMMON.canCraftFluidTanks)),ItemID("fluid_tanks/", result));
    }
