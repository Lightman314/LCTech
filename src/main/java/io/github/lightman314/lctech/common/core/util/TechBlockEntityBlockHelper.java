...
public class TechBlockEntityBlockHelper {
	...
	public static final ResourceLocation FLUID_TANK_TYPE = new ResourceLocation(LCTech.MODID, "fluid_tank");
	...
	static {
		BlockEntityBlockHelper.addBlocksToBlockEntity(FLUID_TANK_TYPE, ModBlocks.IRON_TANK, ModBlocks.GOLD_TANK, ModBlocks.DIAMOND_TANK);
