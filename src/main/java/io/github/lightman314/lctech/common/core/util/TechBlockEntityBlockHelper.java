...
public class TechBlockEntityBlockHelper {
	...
	static {
		BlockEntityBlockHelper.addBlocksToBlockEntity(FLUID_TRADER_TYPE, ImmutableList.of(ModBlocks.FLUID_TAP, ModBlocks.FLUID_TAP_BUNDLE, ModBlocks.FLUID_NETWORK_TRADER_1,
				ModBlocks.FLUID_NETWORK_TRADER_2, ModBlocks.FLUID_NETWORK_TRADER_3, ModBlocks.FLUID_NETWORK_TRADER_4));
		BlockEntityBlockHelper.addBlocksToBlockEntity(ENERGY_TRADER_TYPE, ImmutableList.of(ModBlocks.BATTERY_SHOP, ModBlocks.ENERGY_NETWORK_TRADER));
	}
