...
public class ModTileEntities {
	...
	//Energy Trader
	public static final TileEntityType<EnergyTraderTileEntity> ENERGY_TRADER = buildType("energy_trader", TileEntityType.Builder.create(EnergyTraderTileEntity::new, ModBlocks.BATTERY_SHOP.block));
	
	//Universal Fluid Trader
	public static final TileEntityType<UniversalFluidTraderTileEntity> UNIVERSAL_FLUID_TRADER = buildType("universal_fluid_trader", TileEntityType.Builder.create(UniversalFluidTraderTileEntity::new, ModBlocks.FLUID_SERVER_SML.block, ModBlocks.FLUID_SERVER_MED.block, ModBlocks.FLUID_SERVER_LRG.block, ModBlocks.FLUID_SERVER_XLRG.block));

	//Universal Energy Trader
	public static final TileEntityType<UniversalEnergyTraderTileEntity> UNIVERSAL_ENERGY_TRADER = buildType("universal_energy_trader", TileEntityType.Builder.create(UniversalEnergyTraderTileEntity::new, ModBlocks.ENERGY_SERVER.block));
